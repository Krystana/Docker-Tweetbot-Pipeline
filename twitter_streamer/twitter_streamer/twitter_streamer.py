...
client = pymongo.MongoClient(host='mongodb', port=27017) #hostname is name of container with mongo

# create/use a db on the go:
db = client.tweets_1
...
if __name__ == "__main__":
    ...
    twitter_streamer = TwitterStreamer(['puppy', 'dogs', 'veterinarian']) 
    ...
    while times_to_repeat >= 0:
        ...
        logging.critical('streaming 5 tweets, times to repeat left = {}'.format(times_to_repeat))
        time.sleep(60)

logging.critical('shutdown streamer')